...
By contrast with those clear associations at the zip code level, there is little clear evidence to report at the metropolitan level. (put these figures in the appendix?)

Among the combinations of the two covariates and four outcomes

%-ssc only social wellbeing scale

No matter the specification, 

Notably, even a completely different approach to capturing differences between MSAs - a simple varying-intercepts model with random effects - doesn't reveal notable between-MSA variation.
